...
class ApiTest(unittest.TestCase):
    ...
    def test_get_bar(self):
        ...
        headers = [('Content-Type', 'application/json')]
        headers.append(('Authorization', auth_token))
        response = self.app.get('/bar/test_bar/0', headers=headers)
        data = json.loads(response.data.decode())
        print(data)
        self.assertTrue(data['status'] == 'success')
    ...
    def test_get_specials(self):
        ...
        headers = [('Content-Type', 'application/json')]
        headers.append(('Authorization', auth_token))
        response = self.app.get('/specials/0', headers=headers)
        data = json.loads(response.data.decode())
        print(data)
        self.assertTrue(data['status'] == 'success')
        self.assertTrue(data['message'] == 'Successfully added user.')
    ...
    def test_delete_specials(self):
        ...
        headers = [('Content-Type', 'application/json')]
        headers.append(('Authorization', auth_token))
        data = {'operation': 'delete', 'special_id': 1, 'bar_id':"test_bar", 'day':0}
        json_data = json.dumps(data)
        json_data_length = len(json_data)
    ...
    def test_update_specials(self):
        ...
        headers = [('Content-Type', 'application/json')]
        headers.append(('Authorization', auth_token))
        data = {'day':1,'operation': 'update', 'bar_id':"test_bar", 'special_id':2,
    ...
    def test_create_specials(self):
        ...
        headers = [('Content-Type', 'application/json')]
        headers.append(('Authorization', auth_token))
        data = {'operation': 'create', 'day':1, 'bar_id':"test_bar",
    ...
    def test_add_user_special(self):
        ...
        headers = [('Content-Type', 'application/json')]
        headers.append(('Authorization', auth_token))
        response = self.app.post('/user_specials/test_bar/1/0', headers=headers)
        data = json.loads(response.data.decode())
        print (data)
        self.assertTrue(data['status'] == 'success')
        self.assertEqual(response.status_code, 200)
